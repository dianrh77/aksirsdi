...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div class="main-container min-h-screen bg-content text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div class="main-content flex min-h-screen flex-col ">
            ...
            <header class="z-40" :class="{ 'dark': $store.app.semidark && $store.app.menu === 'horizontal' }">
                <div class="shadow-sm">
                    <div class="relative flex w-full items-left bg-white px-1 py-2.5 dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">

                            <a href="#" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-24 ltr:-ml-1 rtl:-mr-1"
                                    src="{{ asset('assets/images/logo.png') }}" alt="image">
                            </a>
                            <a href="javascript:;"
                                class="collapse-icon flex flex-none rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary ltr:ml-0 rtl:mr-2 dark:bg-dark/40 dark:text-[#d0d2d6] dark:hover:bg-dark/60 dark:hover:text-primary lg:hidden"
                        ...
                        <div x-data="header"
                            class="flex items-right space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                            ...
                            <div>
                                <img class="inline w-27 ltr:-ml-1 rtl:-mr-1 mt-0"
                                    src="{{ asset('assets/images/logo-rsdi-baru.png') }}" alt="image">
                            </div>
                            <div>
                                <a href="javascript:;" x-cloak="" x-show="$store.app.theme === 'light'"
                                    href="javascript:;"
                                    class="flex items-center rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60 mt-2"
                                    @click="$store.app.toggleTheme('dark')">
                                    <svg width="20" height="20" viewbox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="12" r="5" stroke="currentColor"
                            ...
                            <div class="dropdown flex-shrink-0 mt-2" x-data="dropdown"
                                ...
                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                    class="top-11 w-[250px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                                        ...
                                        <div class="flex items-center px-4 py-4">
                                            ...
                                            <div class="truncate ltr:pl-4 rtl:pr-4">
                                                ...
                                                <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                                    href="javascript:;">{{ Auth::user()->primaryPosition()->name ?? 'Pengguna' }}</a>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit"
                                                class="!py-3 px-4 text-danger flex items-center w-full text-left">
                    ...
                    <ul
                        ...
                        <li class="menu nav-item relative">
                            <a href="javascript:;" class="nav-link {{ set_active(['home']) }}">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="{{ route('home') }}" class="{{ set_active(['home']) }}">Sales</a>
                                </li>
                                <li>
                                    <a href="{{ route('analytics') }}"
                                        class="{{ set_active(['analytics']) }}">Analytics</a>
                                </li>
                                <li>
                                    <a href="{{ route('finance') }}"
                                        class="{{ set_active(['finance']) }}">Finance</a>
                                </li>
                                <li>
                                    <a href="{{ route('crypto') }}" class="{{ set_active(['crypto']) }}">Crypto</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu nav-item relative">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="{{ route('apps/chat') }}"
                                        class="{{ set_active(['apps/chat']) }}">Chat</a>
                                </li>
                                <li>
                                    <a href="{{ route('apps/mailbox') }}"
                                        class="{{ set_active(['apps/mailbox']) }}">Mailbox</a>
                                </li>
                                <li>
                                    <a href="{{ route('apps/todolist') }}"
                                        class="{{ set_active(['apps/todolist']) }}">Todo List</a>
                                </li>
                                <li>
                                    <a href="{{ route('apps/notes') }}"
                                        class="{{ set_active(['apps/notes']) }}">Notes</a>
                                </li>
                                <li>
                                    <a href="{{ route('apps/scrumboard') }}"
                                        class="{{ set_active(['apps/scrumboard']) }}">Scrumboard</a>
                                </li>
                                <li>
                                    <a href="{{ route('apps/contacts') }}"
                                        class="{{ set_active(['apps/contacts']) }}">Contacts</a>
                                </li>
                                <li class="relative">
                                    <a href="javascript:;"
                                        class="{{ set_active(['apps/invoice/list', 'apps/invoice/preview', 'apps/invoice/add', 'apps/invoice/edit']) }}">Invoice
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="{{ route('apps/invoice/list') }}"
                                                class="{{ set_active(['apps/invoice/list']) }}">List</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('apps/invoice/preview') }}"
                                                class="{{ set_active(['apps/invoice/preview']) }}">Preview</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('apps/invoice/add') }}"
                                                class="{{ set_active(['apps/invoice/add']) }}">Add</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('apps/invoice/edit') }}"
                                                class="{{ set_active(['apps/invoice/edit']) }}">Edit</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('apps/calendar') }}"
                                        class="{{ set_active(['apps/calendar']) }}">Calendar</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu nav-item relative">
                            <a href="javascript:;"
                                class="nav-link {{ set_active(['users/profile', 'users/account/settings']) }}">
                                <div class="flex items-center">
                                    <svg width="20" height="20" viewbox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                        <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <ul class="sub-menu">
                                <li class="relative">
                                    <a href="javascript:;"
                                        class="{{ set_active(['users/profile', 'users/account/settings']) }}">Users
                                        <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180">
                                            <svg width="16" height="16" viewbox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="{{ route('users/profile') }}"
                                                class="{{ set_active(['users/profile']) }}">Profile</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('users/account/settings') }}"
                                                class="{{ set_active(['users/account/settings']) }}">Account
                                                Settings</a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div class="mt-auto p-6 pt-0 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                © <span id="footer-year"></span>. Hak Cipta Milih Allah Semata.
            </div>
            <!-- end footer section -->
        </div>
    </div>
