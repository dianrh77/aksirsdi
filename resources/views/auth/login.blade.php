                ...
                <div
                    ...
                    <div
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            ...
                            <div class="mt-5 hidden w-full max-w-[430px] lg:block">
                                <img src="assets/images/auth/Login-Aksi.png" alt="Cover Image" class="w-full">
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">log iN
                                </h1>
                                <p class="text-base font-bold leading-normal text-white-dark">Masukkan email dan password
                                    untuk masuk</p>
                            </div>
                        ...
                        <p class="absolute bottom-6 w-full text-center dark:text-white">
                            © <span id="footer-year">2025</span>. Hak Cipta Milik Allah Semata
                        </p>
                    </div>
                </div>
            </div>
